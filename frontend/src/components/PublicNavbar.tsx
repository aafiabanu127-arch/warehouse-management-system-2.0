...
export default function PublicNavbar() {
  ...
  const css = `
    ...
    .nav-link { color:rgba(255,255,255,0.6); text-decoration:none; font-size:13.5px; font-weight:500; padding:6px 14px; border-radius:8px; transition:all 0.25s; cursor:pointer; background:none; border:none; position:relative; font-family:'Inter',sans-serif; }
